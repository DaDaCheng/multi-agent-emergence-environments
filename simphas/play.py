...
def edge_punish(x,y,l=0.3,p=1.6,w=5.0):
    xx=0.0
...
def main(sk=None,hd=None, output='output',speed=1,vlag=0):
    ...
    '''
    if vlag == 0:
        Seeker=PolicyGradientAgent(0.005,[8],n_actions=9,layer1_size=32,layer2_size=32)

        Hider = PolicyGradientAgent(0.005, [8], n_actions=9, layer1_size=32, layer2_size=32)
    else:
        Seeker=sk
        Hider=hd
    a=[]
...
if __name__ == '__main__':
    #S1,H1=main(output='1', speed=3)
    S2,H2 = main(output='2', speed=1)
   # main(sk=S1,hd=H2,output='3', speed=1,vlag=1)
